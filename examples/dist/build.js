...
exports.default = {
    ...
    data: function data() {
        return {
            imgs: ['http://i2.hdslb.com/bfs/archive/37e40edcbb017a7bf9375c9cdc10c36c0e3e86ca.jpg', 'http://img.zcool.cn/community/01bf1655e514b16ac7251df840273f.jpg', 'http://www.bz55.com/uploads/allimg/140328/1-14032Q35627.jpg', 'http://img.kutoo8.com/upload/image/42369237/001%20(3)_960x540.jpg', 'http://file01.up71.com/File/CorpProductImages/2014/04/20/0_yiniujcdd_2514_20140420212740.jpg']
        };
    },

    components: {
        ImagesViewer: _index2.default
    }
}; //
//
//
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        var _first = Array.prototype.slice.call(this.innerList, 0, 1)[0];
    ...
    methods: {
        ...
        _imgsInit: function _imgsInit() {
            ...
            var _imgs = Array.prototype.slice.call(this.innerList, this.currentImgIndex, this.currentImgIndex + 3);
            var _clsMap = {
                0: 'prev',
                1: 'current',
                2: 'next'
            ...
            _imgs.map(function (item, index) {
                var _item = (typeof item === 'undefined' ? 'undefined' : _typeof(item)) == 'object' ? item : {
                    url: item
                };
                _item.autoAni = false;
                _item.scale = 1;
                _item.lastScale = 1;
                _item.transformOriginX = _this2.winWidth / 2;
         ...
         * @private
         */
        _getTargetHeight: function _getTargetHeight(target) {
         ...
         * @param index
         */
        panStartHandle: function panStartHandle(event, item, index) {
            var _imgs = Array.prototype.slice.call(this.imgs);
            var target = _imgs[index];
            var targetHeight = this._getTargetHeight(target); // 缩放之后的高度
         ...
         * @param index
         */
        panMoveHandle: function panMoveHandle(event, item, index) {
         ...
         * @param index
         */
        panEndHandle: function panEndHandle(event, item, index) {
            var _deltaX = event.deltaX;
            var _deltaY = event.deltaY;
            if (this.aniTarget == 3) {
                var _imgs = Array.prototype.slice.call(this.imgs);
                ...
                this.autoAni = true;
                if (Math.abs(_deltaX) < this.winWidth / 3 || this.currentImgIndex + 2 > this.innerList.length - 1 && _deltaX <= 0 || this.currentImgIndex < 1 && _deltaX > 0) {
                    this.imgsWrapTranslateX = 0;
                    return;
                }
         ...
         * @param index
         */
        pinchStartHandle: function pinchStartHandle(event, item, index) {
            var _imgs = Array.prototype.slice.call(this.imgs);
            var target = _imgs[index];
            target.autoAni = false;
            _imgs[index] = target;
         ...
         * @param index
         */
        pinchMoveHandle: function pinchMoveHandle(event, item, index) {
         ...
         * @param index
         */
        pinchEndHandle: function pinchEndHandle(event, item, index) {
            var _imgs = Array.prototype.slice.call(this.imgs);
            var target = _imgs[index];
            var targetHeight = this._getTargetHeight(target);
            if (target.scale < 1) {
                target.autoAni = true;
                target.scale = 1;
         ...
         * @param index
         */
        doubleTapHandle: function doubleTapHandle(event, item, index) {
            var _imgs = Array.prototype.slice.call(this.imgs);
            var target = _imgs[index];

            //图片的原始尺寸和宽高比
            var imgWidth = event.target.naturalWidth;
            var imgHeight = event.target.naturalHeight;
...
Component.options.__file = "/Users/jimmy/Documents/WORKS/frameworks/github-upload-source/vue-images-viewer/examples/Index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d0a7c69", Component.options)
  } else {
    hotAPI.reload("data-v-7d0a7c69", Component.options)
  }
...
Component.options.__file = "/Users/jimmy/Documents/WORKS/frameworks/github-upload-source/vue-images-viewer/src/components/main.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-47d2fe8c", Component.options)
  } else {
    hotAPI.reload("data-v-47d2fe8c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: "iv-container"
  }, [_c('div', {
    staticClass: "iv-items",
    class: {
      'autoani': _vm.autoAni
    },
    style: ({
      transform: ("translateX(" + _vm.imgsWrapTranslateX + "px)")
    })
  }, _vm._l((_vm.imgs), function(item, index) {
    return (_vm.imgs.length > 0) ? _c('div', {
      staticClass: "iv-item-wrap",
      class: item.cls,
      style: ({
      ...
      on: {
        "panstart": function($event) {
          _vm.panStartHandle($event, item, index)
        },
        "panmove": function($event) {
          _vm.panMoveHandle($event, item, index)
        },
        "panend": function($event) {
          _vm.panEndHandle($event, item, index)
        },
        "pinchstart": function($event) {
          _vm.pinchStartHandle($event, item, index)
        },
        "pinchmove": function($event) {
          _vm.pinchMoveHandle($event, item, index)
        },
        "pinchend": function($event) {
          _vm.pinchEndHandle($event, item, index)
        },
        "tap": function($event) {
          _vm.doubleTapHandle($event, item, index)
        }
      }
    }, [(!!item.url) ? _c('img', {
      attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-47d2fe8c", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7d0a7c69", module.exports)
  }
}
...
var update = __webpack_require__(15)("caa64a02", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-47d2fe8c\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-47d2fe8c\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue");
